...
<html lang="en">
  <head>
    ...
    <title>Data Table - Викладач Admin</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <!-- Data table plugin-->
    <script type="text/javascript" src="js/plugins/jquery.dataТаблиці.min.js"></script>
    <script type="text/javascript" src="js/plugins/dataТаблиці.bootstrap.min.js"></script>
